...
void Bootstrapper::bootstrap_sparse_3(Ciphertext &rtncipher, Ciphertext &cipher) {
  ...
  const auto &modulus = iter(context.first_context_data()->parms().coeff_modulus());
  cipher.scale() = ((double)modulus[0].value());
  // cout << "INFO: cipher scale: " << cipher.scale() << endl;
  // cout << "current coff modulus size: " << cipher.coeff_modulus_size() << endl;
  ...
  // cout << "after subsum scale" <<  cipher.scale() << endl;
  // cout << "after subsum coeff modulus size" << cipher.coeff_modulus_size() << endl;
  ...
  if (logn == 0) {
   ...
   // cout << "Coefftoslot..." << endl;
    ...
    // cout << "after coefftoslot scale" <<  rtn.scale() << endl;
    // cout << "after coefftoslot coeff modulus size" << rtn.coeff_modulus_size() << endl;
