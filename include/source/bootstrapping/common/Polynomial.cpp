  ...
  if (deg == 1) {
    ...
    for (int i = 1; i < heap_k; i++) {
      if (!babybool[i]) {
        ...
        // cout << "before rescale" << "baby[i] scale: " << baby[i].scale() << endl;
        evaluator.rescale_to_next_inplace(baby[i]);
        // cout << "after rescale" << "baby[i] scale: " << baby[i].scale() << endl;
        evaluator.double_inplace(baby[i]);

        // cout << "check the addition:";
        // cout << "baby[i] scale: " << baby[i].scale() << endl;
        // cout << "baby[i] level" << context.get_context_data(baby[i].parms_id())->chain_index() << endl;
        // cout << "baby[diff] scale: " << baby[diff].scale() << endl;
        // cout << "baby[diff] level" << context.get_context_data(baby[diff].parms_id())->chain_index() << endl;
